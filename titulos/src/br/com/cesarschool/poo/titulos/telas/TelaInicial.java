	...
	public TelaInicial() {
		...
		btnNewButton_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				AcaoTela novatela = new AcaoTela(btnNewButton_1_1.getText());
		...
		btnNewButton_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				AcaoTela novatela = new AcaoTela(btnNewButton_1_1_1.getText());
				novatela.setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_1_1_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				AcaoTela novatela = new AcaoTela(btnNewButton_1_1_2.getText());
				novatela.setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_1_1_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				AcaoTela novatela = new AcaoTela(btnNewButton_1_1_3.getText());
				novatela.setVisible(true);
				dispose();
			}
		});
